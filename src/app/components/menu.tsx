  ...
  return (
    <div className="bg-white border-b border-gray-200">
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  {
                    !user ? (
                      ...
                      <div className="flow-root">
                        <Link href={''} onClick={() => handleLogout()} className="-m-2 block p-2 font-medium text-gray-900">
                          Sign out
                        </Link>
                      </div>
                    )
      ...
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-[#9BCF53] px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
                ...
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  {
                    !user ? (
                      ...
                      <Link onClick={() => handleLogout()} className="text-sm font-medium text-gray-700 hover:text-gray-800" href={''}>
                        Sign out
                      </Link>
                    )
                  }
